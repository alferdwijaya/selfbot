        ...
        if msg.toType == 2:
            if msg.contentType == 0:
                ...
                if msg.text == "gift":
                    sendMessage(msg.to, text="gift sent", contentMetadata=None, contentType=9)
                if msg.text == "set":
                    sendMessage(msg.to, "Mulai ngecek sider")
                    try:
                ...
                if msg.text == "tes":
                    if msg.to in wait['readPoint']:
                        ...
                        sendMessage(msg.to, "NIH LIST ORANG YANG YANG NYIDER%s\nthat's it\n\nKALO INI DAFTAR ORANG YANG NYIDER TAPI KGK NONGOL\n%sMAALU MALUIN, MINTA JOIN DI GRUB TAPI KERJANGA NYIDER,OUT SANA\n\nTANGGAL NGECEK SIDERn time:\n[%s]"  % (wait['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        sendMessage(msg.to, "PASANG CCTV")
                else:
                    pass
        else:
            pass
